...
Div.prototype = {
  ...
  getOpenTagHtml : function() {
    ...
    if(this.getDataType() != "image") {
      html += "<div class=\"" + this.getClassify() + "\">";
    } else {
      html += "<div class=\"" + this.getClassify() + "\">";
      html +=    "<img src=\"../img/sample/" + this.getSrc() + ".png\" />";
    }
  ...
  getCss : function() {
    ...
    if(this.getDataType() == "image") {
      cssForImage += "." + this.getClassify() + " img { width: 100%; height: 100%; } ";
    } else if(this.getDataType() == "text") {
      cssForImage += "." + this.getClassify() + " textarea { width: 100%; height: 100%; } ";
    }

    var css = cssForImage + selector + " {";

    console.log(typeof(componentAttrs));
    ...
    for(var [key, value] of componentAttrs) {
      if(key == "float") {
        ...
        var widthValue = dip.parsePercentFromPixel(value, this.getWidthMax());

        css += key + ": ";
        css += widthValue + "%; ";
      } else if(key == "height") {

        var heightValue = dip.parsePercentFromPixel(value, this.getHeightMax());
...
Text.prototype.getFontStyle = function() { return this.fontStyle; }
Text.prototype.setFontStyle = function(fontStyle) { this.fontStyle = fontStyle; return this; }

Text.prototype.getFontSize = function() { return this.fontSize; }
Text.prototype.setFontSize = function(fontSize) { this.fontSize = fontSize; return this; }

Text.prototype.getColor = function() { return this.color; }
Text.prototype.setColor = function(color) { this.color = color; return this; }

Text.prototype.getFontWeight = function() { return this.fontWeight; }
Text.prototype.setFontWeight = function(fontWeight) { this.fontWeight = fontWeight; return this; }

Text.prototype.getFontFamily = function() { return this.fontFamily; }
Text.prototype.setFontFamily = function(fontFamily) { this.fontFamily = fontFamily; return this; }

Text.prototype.getTextAlign = function() { return this.textAlign; }
Text.prototype.setTextAlign = function(textAlign) { this.textAlign = textAlign; return this; }

Text.prototype.applyComponentAttrs = function() {
  Div.prototype.applyComponentAttrs.call(this);
  $("#" + this.getDipId() + " textarea").text(this.getText());
  $("#" + this.getDipId() + " textarea").css("font-style", this.getFontStyle());
  $("#" + this.getDipId() + " textarea").css("font-size", this.getFontSize());
  $("#" + this.getDipId() + " textarea").css("font-weight", this.getFontWeight());
  $("#" + this.getDipId() + " textarea").css("font-family", this.getFontFamily());
  $("#" + this.getDipId() + " textarea").css("text-align", this.getTextAlign());
  $("#" + this.getDipId() + " textarea").css("color", this.getColor());
}

Text.prototype.getAttrs = function() {
  var attrs = Div.prototype.getAttrs.call(this);
  attrs.set("fontStyle", this.getFontStyle());
  attrs.set("fontSize", this.getFontSize());
  attrs.set("fontWeight", this.getFontWeight());
  attrs.set("fontFamily", this.getFontFamily());
  attrs.set("textAlign", this.getTextAlign());
  attrs.set("color", this.getColor());
...
Image.prototype.getImageWidth = function() { return this.imageWidth; }
Image.prototype.setImageWidth = function(imageWidth) { this.imageWidth = imageWidth; return this; }

Image.prototype.getImageHeight = function() { return this.imageHeight; }
Image.prototype.setImageHeight = function(imageHeight) { this.imageHeight = imageHeight; return this; }

Image.prototype.applyComponentAttrs = function() {
  UBR.prototype.applyComponentAttrs.call(this);

  // $("#" + this.getDipId() + " img").css({"width" : this.getWidth()});
  // $("#" + this.getDipId() + " img").css({"height" : this.getHeight()});
}

Image.prototype.getAttrs = function() {
  var attrs = UBR.prototype.getAttrs.call(this);
  attrs.set("imageWidth", this.getImageWidth());
  attrs.set("imageHeight", this.getImageHeight());
